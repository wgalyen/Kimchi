...
mod test {
    ...
    fn test_extract_markdown_links() {
        ...
        assert_eq!(
            links,
            [
                website("https://mechanikadesign.com"),
                website("https://github.com/wgalyen/kimchi/relative_link"),
            ]
            .iter()
            .cloned()
            .collect()
    ...
    fn test_non_markdown_links() {
        let input =
            "https://mechanikadesign.com and https://mechanikadesign.com/foo/bar?lol=1 at test@example.org";
        ...
        let expected = [
            website("https://mechanikadesign.com"),
            website("https://mechanikadesign.com/foo/bar?lol=1"),
